...
Задание по лабораторной работе выдает преподаватель. Для получения задания необходимо форкнуть ее репозиторий, и преподаватель сделает коммит, содержащий текст задания.

Лабораторная работа представляет собой файл скрипта с выполненным заданием, к которому должны быть приложены файл скрипта создания и заполнения базы данных и файл-скриншот схемы данных из Microsoft Access. Все эти файлы должны быть сохранены в репозитории и представлены в pull-request.
