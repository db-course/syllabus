...
Для тренировки навыков использования операций и проверкивыполнения запросов рекомендуется использовать [тренажер реляционной алгебры](https://aksenov.in/ra/)
