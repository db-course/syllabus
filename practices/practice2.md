...
Предварительно ознакомиться: [материалы лекций по оператору SELECT](https://github.com/db-course/lecture-notes/blob/master/04/lecture4.md).
...
1. [Интерактивный учебник по SQL. Оператор SELECT](https://www.sql-tutorial.ru/ru/book/sql_dml/select_statement/)
