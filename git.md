...
Для того чтобы выполнять лабораторные работы 3-5, нужно быть членом организации db2015ss на GitHub. Для этого необходимо после регистрации на GitHub подать заявку на вступление, которую принимает преподаватель. Для этого необходимо открыть issue (проблему) в репозитории [db2015ss/students](https://github.com/db2015ss/students). Как это сделать, указано в описании репозитория.
...
![](https://github.com/db2015ss/syllabus/blob/master/img/privat_repo.png)
...
![](https://github.com/db2015ss/syllabus/blob/master/img/fork.png)

Через несколько секунд на сервере GitHub будет создана ваша копия репозитория проекта.

![](https://github.com/db2015ss/syllabus/blob/master/img/forking.png)
...
В ней указывается, в какой репозиторий происходит публикация (origin — репозиторий-источник, который был клонирован) и в какую ветвь (master — главная ветвь). У проекта может быть несколько ветвей, но ветвление не используется при сдаче лабораторных работ и здесь не рассмотрено.
...
![](https://github.com/db2015ss/syllabus/blob/master/img/pullrequest1.png)

Затем нажмите Create pull request.

![](https://github.com/db2015ss/syllabus/blob/master/img/pullrequest2.png)

На следующей странице вам будет предложено написать заголовок и комментарий к своему запросу. Не пренебрегайте этим.

![](https://github.com/db2015ss/syllabus/blob/master/img/comment_on_pullrequest.png)
...
![](https://github.com/db2015ss/syllabus/blob/master/img/conversation.png)
...
![](https://github.com/db2015ss/syllabus/blob/master/img/code_review.png)

Вы также можете отвечать на эти комментарии.

![](https://github.com/db2015ss/syllabus/blob/master/img/answer.png)

При появлении новых событий, связанных со сдачей работы, в правом верхнем углу будет отображено уведомление.

![](https://github.com/db2015ss/syllabus/blob/master/img/alert.png)
