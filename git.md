...
```
`ваш@email` - адрес электронной почты. Чтобы коммиты, которые вы создаете, ассоциировались с вашим пользователем на GitHub, необходимо использовать адрес электронной почты, предоставляемый GitHub и имеющий вид `ivanov@users.noreply.github.com`, где `ivanov` -- ваше имя пользователя.
