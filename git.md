...
Следует помнить, что репозиторий 0ЛР, в отличие от репозиториев всех остальных работ, не имеет разделения на группы, поэтому для доступа к нему следует использовать имя `labwork0`, а не `labwork0-4141` или подобное.
...
Будет создан локальный каталог (в данном случае `labwork3-4141`), содержащий файл `README.md` (текстовый файл с описанием репозитория в формате markdown) и, другие файлы, если это предусмотрено лабораторной работой. Можно приступать к выполнению лабораторной работы.
...
Далее вам будет предложено написать заголовок и комментарий к своему пулл-реквесту. В заголовке напишите свою фамилию и номер группы. Комментарий можно оставить пустым.
