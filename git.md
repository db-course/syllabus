...
![](https://github.com/db2016ss/syllabus/blob/master/img/workflow.png)
...
Для того чтобы выполнять лабораторные работы 3-5, нужно быть членом организации db2016ss на GitHub. Для этого необходимо после регистрации на GitHub подать заявку на вступление, которую принимает преподаватель. Для этого необходимо открыть issue (проблему) в репозитории [db2016ss/students](https://github.com/db2016ss/students). Как это сделать, указано в описании репозитория.

Когда вы станете членом организации db2016ss, вам станут доступны один или несколько приватных (невидимых для пользователей, не являющихся членами) репозиториев, каждый из которых относится к какой-либо из лабораторных работ, для которых предусмотрена сдача на GitHub. Можно приступать к выполнению лабораторных работ 3-5.

![](https://github.com/db2016ss/syllabus/blob/master/img/privat_repo.png)

Если есть желание потренироваться в использовании приемов работы с GitHub, можно использовать в качестве песочницы репозиторий [db2016ss/students](https://github.com/db2016ss/students). В его описании указано, для чего он предназначен и как с помощью него можно отработать навыки перед сдачей лабораторных работ.

## Подготовка к выполнению лабораторной работы

Необходимо форкнуть (fork) приватный репозиторий, относящийся к лабораторной работе, которую вы хотите сдать. Для этого необходимо зайти в репозиторий, соответствующий работе (например, db2016ss/labwork3 для 3-й ЛР), и нажать кнопку Fork.

![](https://github.com/db2016ss/syllabus/blob/master/img/fork.png)

Через несколько секунд на сервере GitHub будет создана ваша копия репозитория проекта.

![](https://github.com/db2016ss/syllabus/blob/master/img/forking.png)
...
Чтобы сдать работу, необходимо отослать историю ваших изменений в центральный репозиторий этой работы в организации db2016ss. Там их увидит и оценит преподаватель. 
...
![](https://github.com/db2016ss/syllabus/blob/master/img/pullrequest1.png)

На появившейся странице будут отображены изменения, которые вы внесли в файлы репозитория. Нажмите Create pull request.

![](https://github.com/db2016ss/syllabus/blob/master/img/pullrequest2.png)

Далее вам будет предложено написать заголовок и комментарий к своему запросу.

![](https://github.com/db2016ss/syllabus/blob/master/img/comment_on_pullrequest.png)
...
![](https://github.com/db2016ss/syllabus/blob/master/img/conversation.png)
...
![](https://github.com/db2016ss/syllabus/blob/master/img/code_review.png)

Вы также можете отвечать на эти комментарии.

![](https://github.com/db2016ss/syllabus/blob/master/img/answer.png)

При появлении новых событий, связанных со сдачей работы, в правом верхнем углу страницы сайта будет отображено уведомление.

![](https://github.com/db2016ss/syllabus/blob/master/img/alert.png)
